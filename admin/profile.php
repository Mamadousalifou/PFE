...
?>
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          ...
          <div class="container">
              ...
              <a  data-toggle="modal" data-target="#editModal" class="btn btn-success" >Modifier</a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <input type="email" name="email" value="<?php  echo $_SESSION['email'];  ?>" class="form-control" placeholder="tapez votre email..."> 
        ...
        <div class="form-group">  
        <input type="password" name="mp" value ="" class="form-control" placeholder="tapez votre mot de pass...">     
      </div>
